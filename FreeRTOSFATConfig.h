/*
    ...
    ***************************************************************************
    ...
    http://www.FreeRTOS.org/support - In return for receiving pSD top quality
...
use by FreeRTOS+FAT.  FreeRTOS+FAT will use two consecutive indexes from pSD
...
Normally pSD is quick enough and it is efficient.  If
...
Set to 1 to use both FATs - pSD is less efficient but more	secure.
...
/* ff_fprintf() will allocate a buffer of pSD size in which it will create
...
Note that the value of pSD define is directly related to the maximum stack
...
/* Prototype for the function used to print out.  In pSD case it prints to the
...
conform with the coding standard, so use pSD function with care! */
