...
static void create_big_file(const char *const pathname, size_t size, unsigned seed) {
    int32_t lItems;
    FF_FILE *pxFile;
...
// Read a file of size "size" bytes filled with random data seeded with "seed" and verify the data
static void check_big_file(const char *const pathname, size_t size, uint32_t seed) {
    int32_t lItems;
    FF_FILE *pxFile;
...
// Create a file of size "size" bytes filled with random data seeded with "seed"
//static 
void create_big_file_v1(const char *const pathname, size_t size, unsigned seed) {
    int32_t lItems;
    FF_FILE *pxFile;
    int val;    
