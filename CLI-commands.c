...
static BaseType_t prvCLSCommand( char *pcWriteBuffer, size_t xWriteBufferLen, const char *pcCommandString );
...
static const CLI_Command_Definition_t xCLS =
{
    "cls",
    "cls:\r\n Clear screen\r\n\r\n",
    prvCLSCommand,
